      ...
      {editing ? (
        <>
          ...
          <div className="flex gap-2 mt-2">
            <button className="bg-blue-500 text-white px-3 py-1 rounded shadow-window-pixel font-pixel" onClick={handleSave}>Save</button>
        ...
        <>
          ...
          {form.market_address && (
            <div className="text-xs mb-1">
              <span className="bg-yellow-200 text-blue-900 px-2 py-1 rounded font-mono border border-black" title={form.market_address}>
