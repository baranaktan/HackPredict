...
const SideNav = () => {
  ...
  return (
    <aside className={`hidden lg:flex ${isCollapsed ? 'w-16' : 'w-52'} bg-blue-600 text-cream flex-col gap-2 py-6 border-r-4 border-black transition-all duration-300 relative`}>
      {/* Toggle Button */}
      <button
        onClick={toggleCollapse}
        className="absolute -right-3 top-6 bg-periwinkle text-cream p-1 rounded-full border-2 border-black hover:bg-blue-800 transition-colors"
      >
      ...
      <div className="mt-auto px-3 pb-4">
        <div className="flex flex-col gap-2">
          <a 
            href="https://github.com/mollybeach/hackpredict" 
            target="_blank" 
          ...
          <a 
            href="https://twitter.com/hackpredict" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-cream hover:text-butter transition-colors"
          >
