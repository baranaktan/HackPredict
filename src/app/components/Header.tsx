...
const Header = () => {
  ...
  return (
    <header className="relative z-10 px-4 sm:px-6 py-4 bg-blue-600 border-b-4 border-black">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-blue-600 border-b-4 border-black z-20">
