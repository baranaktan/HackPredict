        ...
        <div className="max-w-6xl mx-auto">
              ...
              <div className="relative group">
                ...
                {authenticated && (
                  <button
                    ...
                    className="absolute -top-2 -right-2 bg-blue-600 hover:bg-blue-700 text-yellow-50 p-1 border-2 border-black rounded-none opacity-0 group-hover:opacity-100 transition-opacity"
                  >
                    <Edit3 size={12} />
                  </button>
                )}
                    ...
                    >
                      ...
                      {authenticated && (
                        <button
                          ...
                          className="absolute -top-1 -right-1 bg-blue-600 hover:bg-blue-700 text-yellow-50 p-0.5 border border-black rounded-none opacity-0 group-hover:opacity-100 transition-opacity"
                        >
                          <Edit3 size={8} />
                        </button>
                      )}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-coral border-4 border-black p-4 text-center">
              <div className="text-blue-600 text-2xl font-bold">{displayProfile.stats.totalBets}</div>
              <div className="text-cream text-sm">Total Bets</div>
            </div>
            <div className="bg-coral border-4 border-black p-4 text-center">
              <div className="text-blue-600 text-2xl font-bold">{displayProfile.stats.winRate}%</div>
              <div className="text-cream text-sm">Win Rate</div>
            </div>
            <div className="bg-coral border-4 border-black p-4 text-center">
              <div className="text-blue-600 text-2xl font-bold">{displayProfile.stats.totalWinnings}</div>
              <div className="text-cream text-sm">Total Winnings</div>
            </div>
            <div className="bg-coral border-4 border-black p-4 text-center">
              <div className="text-blue-600 text-2xl font-bold">{displayProfile.stats.activeProjects}</div>
                ...
                {displayProfile.recentBets.map((bet) => (
                  <div key={bet.id} className="bg-cream border-2 border-black p-3 flex justify-between items-center">
                    <div>
                      ...
                      <div className="text-xs text-blue-700">{bet.date}</div>
                    </div>
                    <div className="text-right">
