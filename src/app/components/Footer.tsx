  ...
  <footer className="bg-plum border-t-4 border-black py-4">
    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between px-4 sm:px-6 text-cream">
      ...
      <div className="flex gap-3 sm:gap-4">
        ...
        <a href="https://github.com/mollybeach/hackpredict" target="_blank" rel="noopener noreferrer" className="hover:text-butter text-xs">
        ...
        <a href="https://twitter.com/hackpredict" target="_blank" rel="noopener noreferrer" className="hover:text-butter text-xs">
          <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
