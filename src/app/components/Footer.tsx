  ...
  <footer className="bg-plum border-t-4 border-black py-4">
    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between px-4 sm:px-6 text-cream">
      <div className="flex items-center gap-2 mb-2 sm:mb-0">
        ...
        <span className="font-bold text-sm sm:text-base">HackPredict</span>
        <span className="text-xs text-butter ml-2 hidden sm:inline">© {new Date().getFullYear()} Ahmet Baran Aktan, Yunus Emre Malkoç, İbrahim Halil Bakışmaz, Mehmet Göktuğ Karoğlu</span>
      ...
      <div className="flex gap-3 sm:gap-4">
        ...
        <a href="https://github.com/baranaktan/HackPredict" target="_blank" rel="noopener noreferrer" className="hover:text-butter text-xs">
