...
const PixelWindow = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="bg-blue-500/90 border-4 border-black rounded-none shadow-window-pixel">
    <div className="flex items-center justify-between px-3 py-1 bg-blue-600 text-yellow-50 font-pixel">
      <span>{title}</span>
