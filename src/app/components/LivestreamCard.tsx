...
export default function LivestreamCard({ livestream, onView }: LivestreamCardProps) {
  ...
  return (
    <div 
      className="bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:transform hover:scale-105 cursor-pointer"
