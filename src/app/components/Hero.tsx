...
/**
 * 🪄 Pixel-styled Hero section for HackPredict
...
const Hero = () => (
  <>
    <Head>
      <title>HackPredict - Real-time Prediction Markets</title>
      <meta
        name="description"
    ...
    <section className="relative px-4 py-16 bg-blue-200 text-blue-900">
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* Description */}
        <div className="border-4 border-black bg-blue-100 shadow-window-pixel max-w-3xl mx-auto mb-10">
      ...
      <div className="p-6 text-center text-blue-900">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <button className="bg-blue-200 text-blue-800 border-2 border-black px-6 py-3 text-xs uppercase shadow-window-pixel hover:bg-blue-300 transition-all">
            💡 Learn More
          </button>
        </div>

        {/* Hero Video Placeholder */}
        <div className="border-4 border-black bg-blue-100 shadow-window-pixel p-4 max-w-4xl mx-auto">
          <div className="aspect-video bg-blue-200 flex items-center justify-center border-2 border-black">
