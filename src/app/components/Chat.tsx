  ...
  return (
    <div className="min-h-screen bg-mauve p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-plum border-4 border-black p-4 mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-cream">HackPredict Chat</h1>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <div className="flex-1">
                <input
                  ...
                  className="w-full px-3 py-2 border-2 border-black bg-cream text-plum text-sm focus:outline-none focus:border-blue-500"
                />
              </div>
              <Button
        ...
        {/* Chat Info */}
        <div className="mt-4 bg-blue-600 border-4 border-black p-4">
