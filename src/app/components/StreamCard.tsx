    ...
    <div className="relative">
      ...
      >
        ...
        {videoError && stream_url && (
          <div className="absolute inset-0 w-full h-full bg-gradient-to-br from-red-400 to-orange-400 flex items-center justify-center">
            <div className="text-white text-center">
      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {category && <p className="text-xs text-blue-600 font-medium capitalize">{category}</p>}
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <Button 
            ...
            className="flex-1 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white rounded-lg font-medium text-xs sm:text-sm py-2 sm:py-2.5 transition-all duration-200 flex items-center justify-center gap-1 sm:gap-2"
          >
            <span>🎯</span>
