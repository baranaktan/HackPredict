            ...
            <div className="mb-4">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 border-2 border-black bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 rounded-none"
                  onKeyPress={(e) => e.key === 'Enter' && handleComment()}
                />
                <button
                  onClick={handleComment}
                  disabled={isLoading || !newComment.trim()}
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-yellow-50 border-2 border-black rounded-none font-bold transition-colors"
                >
                  <Send size={16} />
                </button>
              </div>
