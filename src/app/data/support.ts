...
export const mockFaqs: FAQItem[] = [
  ...
  {
    id: 4,
    question: "What are the fees for using HackPredict?",
    answer: "HackPredict charges a 2% platform fee on all bets. Gas fees for blockchain transactions are additional and vary based on network congestion.",
    category: "Fees",
  },
  {
    id: 5,
...
export const mockContactMethods: ContactMethod[] = [
  {
    ...
    contact: "support@hackpredict.io",
    action: "Send Email",
  },
  {
    icon: "MessageCircle",
...
export const mockHelpResources: HelpResource[] = [
  ...
  },
  {
    ...
    link: "https://discord.gg/hackpredict",
  },
  {
    icon: "Globe",
    title: "Blog",
