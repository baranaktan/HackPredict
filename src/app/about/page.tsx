...
const AboutPage = () => (
  <div className="min-h-screen bg-blue-200 text-blue-900 pt-8">
    ...
    <section className="max-w-2xl mx-auto bg-yellow-50 border-4 border-black shadow-window-pixel p-6 text-center">
      ...
      <p className="mb-4">Created by <span className="text-blue-600 font-bold">Molly Beach</span>, <span className="text-blue-600 font-bold">Ziz Khu</span>, and <span className="text-blue-600 font-bold">João Santos</span>.</p>
