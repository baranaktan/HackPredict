...
// Helper function to get the HackPredict logo URL
export const getHackPredictLogoUrl = (transformations: Record<string, any> = {}) => {
...
export const HACK_PREDICT_LOGO_URL = 'https://res.cloudinary.com/storagemanagementcontainer/image/upload/v1751729735/live-stakes-icon_cfc7t8.png';
// Backward compatibility alias
export const LIVE_STAKES_LOGO_URL = HACK_PREDICT_LOGO_URL; 