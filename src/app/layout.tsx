...
export const metadata: Metadata = {
  title: "HackPredict | AI-Powered Hackathon Prediction Markets",
  description:
    "Watch hackathon livestreams and bet on them with AI-generated opportunities.",
  keywords:
    "hackathon, prediction markets, AI betting, streaming platform, live entertainment, AI predictions, real-time betting, stream betting",
  authors: [{ name: "HackPredict Team" }],
  icons: {
  ...
  openGraph: {
    title: "HackPredict | AI-Powered Hackathon Prediction Markets",
    description:
      "Watch hackathon livestreams and make money with AI-generated betting opportunities.",
    type: "website",
    locale: "en_US",
    images: [
      {
  ...
  twitter: {
    ...
    title: "HackPredict | Smart Betting on Hackathon Streams",
    description: "AI-powered prediction markets for hackathons. Watch, predict, earn.",
    images: ["https://res.cloudinary.com/storagemanagementcontainer/image/upload/v1751729735/live-stakes-icon_cfc7t8.png"],
  },
  robots: "index, follow",
  manifest: "/manifest.json",
  applicationName: "HackPredict",
  appleWebApp: {
    capable: true,
  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <meta name="apple-mobile-web-app-title" content="HackPredict" />
      ...
      {/* ---------------------------------------------------------------- */}
      <body className="min-h-screen bg-blue-200 text-blue-900" suppressHydrationWarning={true}>
        <ClientWrapper>
          <Header />
